...
class ProduitValider extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _ProduitValider();
  }
}

class _ProduitValider extends State<ProduitValider> {
  List categories = [
    "Art",
    "Vetements",
    "Alimentaire",
...
class _ListageProduit extends State<ListageProduit> {
  ...
  @override
  void initState() {
    controller.produitNonValider(widget.categorie!, true);
    super.initState();
  }
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () {
                          det['statutMar'] = v;
                          controller.updateProduit(det, v);
                        },
